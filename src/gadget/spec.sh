...
do
    ...
    python3 GSA.py --text_only --binary_version wpd --result_folder_name ${bench} /home/rudy/wo/spec/spec2017/benchspec/CPU/$bench/build/build_peak_mytest-m64.0000/$bench"_wpd_base" /home/rudy/wo/whole-program-debloat/results/2021-06-18/security/$bench/debrt-mapped-rx-pages_wpd.out $start $size
done
...
do
    ...
    python3 GSA.py --text_only --binary_version wpd_cl --result_folder_name ${bench} /home/rudy/wo/spec/spec2017/benchspec/CPU/$bench/build/build_peak_mytest-m64.0000/$bench"_wpd_custlink" /home/rudy/wo/whole-program-debloat/results/2021-06-18/security/$bench/debrt-mapped-rx-pages_wpd_cl.out $start $size
done
...
do
    ...
    python3 GSA.py --text_only --binary_version wpd_sink --result_folder_name ${bench} /home/rudy/wo/spec/spec2017/benchspec/CPU/$bench/build/build_peak_mytest-m64.0000/$bench"_wpd_sink" /home/rudy/wo/whole-program-debloat/results/2021-06-18/security/$bench/debrt-mapped-rx-pages_wpd_sink.out $start $size
done
...
do
    ...
    python3 GSA.py --text_only --binary_version wpd_cl_sink --result_folder_name ${bench} /home/rudy/wo/spec/spec2017/benchspec/CPU/$bench/build/build_peak_mytest-m64.0000/$bench"_wpd_custlink_sink" /home/rudy/wo/whole-program-debloat/results/2021-06-18/security/$bench/debrt-mapped-rx-pages_wpd_cl_sink.out $start $size
done